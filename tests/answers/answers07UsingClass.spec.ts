...
import { LoanApplication } from './builders/loanApplicationClass';
 ...
 */
const test_data = [
  { loanApplication: new LoanApplication({ amount: 10000, downPayment: 1000 }) , expectedResult: false },
  { loanApplication: new LoanApplication({ amount: 5000, downPayment: 500 }) , expectedResult: true },
  { loanApplication: new LoanApplication({ amount: 100, downPayment: 10 }) , expectedResult: true }
]
